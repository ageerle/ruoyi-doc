...
::: warning 企业版本功能
企业微信功能只在企业版本提供,如需购买请联系作者。
:::
#### 创建企微应用
首先在 企业微信管理后台，点击 "应用管理" 菜单，点击创建应用:
![alt text](/images/weixin/wx-01.webp)
#### 获取 企业ID
点击 "我的企业" 菜单，在最下方可以看到 "企业ID"
![alt text](/images/weixin/wx-02.webp)
#### 获取 AgentId 和 Secret
进入创建的应用主页，获取 AgentId 和 Secret：
![alt text](/images/weixin/wx-03.webp)
...
![alt text](/images/weixin/wx-04.webp)
#### 填写配置
![alt text](/images/weixin/wx-05.webp)
